...
<html>
    ...
    <body>
        ...
        <hr>
    <center>
        <form class="form-inline" action="FoodListServlet" method="post">
        ...
        <div>
            <table class="table" style="text-align: center">
                    ...
                    <c:forEach items="${foodlist}" var="fl" varStatus="vs">
                        <tr>
                            <td>${count}</td>
                            <td>${fl.menu}</td>
                            <td>${fl.unit}</td>
                            <td>${fl.calories}</td>
                            <td>
                                <input type="checkbox" name="fid" value="${fl.foodId}" title="Add to my calories"/>
                            </td>
